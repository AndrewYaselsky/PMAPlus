...
table tr.hover:not(.nopointer) th {
    background:  green <?php echo $GLOBALS['cfg']['BrowsePointerBackground']; ?>;
    color:   <?php echo $GLOBALS['cfg']['BrowsePointerColor']; ?>;
}
...
.config-form ul.tabs li.active a {
    background-color: #4a168e !important;
}
...
.CodeMirror{
    ...
    box-shadow: 3px 3px 15px rgba(0,0,0,.05) !important;
	margin-bottom: 10px;
	font-size: 15px;
}
